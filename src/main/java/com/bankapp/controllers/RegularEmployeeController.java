...
//	        }
	    ...
	    @RequestMapping(value = "/employee_transactions", method = RequestMethod.GET, params="action=Modify")
	    public ModelAndView modifytransaction(@ModelAttribute("row") Transaction Id, BindingResult result,
	            WebRequest request, Errors errors, Principal principal) {
	        ModelAndView mv = new ModelAndView();
	        System.out.println("Entered Modify");
	        System.out.println("Transaction" + Id.getTransactionId());
...
//	        }
	    ...
	    // EMPLOYEE MODIFY/UPDATE TRANSACTION 
	    @RequestMapping(value = "/modifyamount_transactions", method = RequestMethod.POST, params="action=Modify")
	    public ModelAndView updatemodifytransaction(@ModelAttribute("row") Transaction Id,@ModelAttribute("amount") Double Amount, BindingResult result,
	            WebRequest request, Errors errors, Principal principal) {
	        ModelAndView mv = new ModelAndView();
	        System.out.println("Entered Modifyamount");
	        System.out.println("Transaction" + Id.getTransactionId());
	        ...
	        Account FromAccount = transaction.getFromAccount();
	        Account ToAccount = transaction.getToAccount();
	        Double AmountToBeSent = trans.update_Amount(Amount,transaction);
